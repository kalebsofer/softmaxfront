    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-16">
        ...
        <ol className="list-decimal list-inside mb-4 space-y-2">
          ...
          <li><strong>Right to rectification:</strong> You are entitled to have your data corrected if it is inaccurate or incomplete.</li>
          <li><strong>Right to erasure:</strong> Also known as 'the right to be forgotten'. It enables you to request the deletion or removal of your personal data where there's no compelling reason for us to keep processing it.</li>
          ...
          <li><strong>Right to data portability:</strong> This allows you to obtain and reuse your personal data for your own purposes across different services.</li>
          <li><strong>Right to object:</strong> You have the right to object to processing for direct marketing and also to processing which is carried out for the purposes of our legitimate interests.</li>
          <li><strong>Rights related to automated decision making including profiling:</strong> You can object to any decision based solely on automated processing and request human intervention.</li>
          <li><strong>Right to lodge a complaint:</strong> You have the right to lodge a complaint about the way we handle or process your personal data with your national data protection regulator.</li>
          <li><strong>Right to withdraw consent:</strong> If you have given your consent to anything we do with your personal data, you have the right to withdraw your consent at any time.</li>
        </ol>
        ...
        <ul className="list-disc list-inside mb-4 space-y-2">
          ...
          <li>Information provided voluntarily by you. For example, when you register for information or submit an application. This may include:
            <ul className="list-disc list-inside ml-4 mt-2 space-y-1">
              ...
              <li>Other information as submitted from time to time</li>
            </ul>
          </li>
        ...
        <ul className="list-disc list-inside mb-4 space-y-2">
          ...
          <li>To send updates via our newsletter</li>
          <li>To contact you to ensure our records are up to date</li>
        ...
        <p className="mb-4">
          You can contact us by writing to the business address given above, by sending an email to <a href="mailto:hello@softmax.com" className="text-blue-600 hover:underline">hello@softmax.com</a>
        </p>
        <p className="mb-4">
