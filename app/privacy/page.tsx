      ...
      <main className="flex-grow container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <ol className="list-decimal list-outside ml-6 mb-4 space-y-4">
            ...
            <li>
              <strong>Right to data portability:</strong> This allows you to obtain and reuse your personal data for your own purposes across different services. It allows you to move, copy or transfer personal data easily from one IT environment to another in a safe and secure way.
            </li>
            <li>
              <strong>Right to object:</strong> You have the right to object to processing for direct marketing (which we will only do with your consent) and also to processing which is carried out for the purposes of our legitimate interests.
            </li>
            <li>
              <strong>Rights related to automated decision making including profiling:</strong> This allows you to object to any decision based solely on automated processing and you can request the chance to have a decision considered by a human so that they are able to express their point of view, or challenge the decision.
            </li>
            <li>
